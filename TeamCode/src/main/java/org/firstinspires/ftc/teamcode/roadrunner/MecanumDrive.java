...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0005225165806;
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 22856.489058577547;

        // feedforward parameters (in tick units)
        public double kS = 1.6743134987853905;
        public double kV = 0.00008227257536088293;
