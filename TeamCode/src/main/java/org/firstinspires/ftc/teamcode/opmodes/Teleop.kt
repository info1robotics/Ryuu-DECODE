...
class Teleop : LinearOpMode() {
    ...
    private var distanceError = 0.0// failsafe
    private var heading = 0.0//robot s heading
    private var ta =0.0//target area of a april tag
    ...
    override fun runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested) {
            ...
            ta = Limelight.getTa()!!
            distanceLL = ta?.let { Limelight.getDistanceToAprilTag(it) }!!
            ...
            log.add("distance from"+allianceColour.toString()+"goal" + distancePP)
            log.tick()
        }
    }
}